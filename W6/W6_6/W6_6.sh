...
### Advanced - Part 6 - Setting up a robot simulation (Basic)
...
# we need to download this file and move it to my_package/worlds/
W6_6/my_world.wbt

# edit the my_robot_driver plugin
cd ~/ros2_ws/src/my_package/include/my_package

echo "#ifndef WEBOTS_ROS2_PLUGIN_EXAMPLE_HPP
...
#endif" > MyRobotDriver.hpp

cd ~/ros2_ws/src/my_package/src

echo "#include "my_package/MyRobotDriver.hpp"
...
PLUGINLIB_EXPORT_CLASS(my_robot_driver::MyRobotDriver,
                       webots_ros2_driver::PluginInterface)" > MyRobotDriver.cpp


# creating the my_robot.urdf
cd ~/ros2_ws/src/my_package/resource
touch my_robot.urdf
