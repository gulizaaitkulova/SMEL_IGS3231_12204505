...
### Advanced - Part 7 - Setting up a robot simulation (Advanced)
...
# creating obstacle avoiding hpp file
cd ~ros2_ws/src/my_package/include/my_package
touch ObstacleAvoider.hpp
...
# creating obstacle avoiding cpp file
cd ~ros2_ws/src/my_package/src
touch ObstacleAvoider.cpp

echo "#include "my_package/ObstacleAvoider.hpp"
